<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- <li class="{{ Request::is(patterns: 'admin/datewise-rooms') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_datewise_rooms') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Datewise Rooms"><i class="fa fa-calendar"></i> <span>Datewise Rooms</span></a></li> --}}
...
{{-- 
            ...
            <li class="{{ Request::is('admin/customers') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.customer_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Customers"><i class="fa fa-user-plus"></i> <span>Customers</span></a></li>
            
            {{-- <li class="{{ Request::is('admin/users') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.user_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Users">
                    <i class="fa fa-users"></i> <span>Users</span>
                </a>
            </li> --}}
            <li class="{{ Request::is('admin/reviews') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.review_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Reviews">
                    <i class="fa fa-comments"></i> <span>Reviews</span>
                </a>
            </li>
            
            
            <li class="{{ Request::is('admin/order/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.order_index') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Orders"><i class="fa fa-cart-plus"></i> <span>Orders</span></a></li>
        
            <li class="{{ Request::is('admin/coupons*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.coupon_index') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Coupons">
