...
<html lang="en">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 right-side">
                        <ul class="right">
                            ...
                            @if(isset($global_page_data) && $global_page_data->cart_status == 1)
                            ...
                            @if(isset($global_page_data) && $global_page_data->checkout_status == 1)
                            ...
                            @if(isset($global_page_data) && $global_page_data->signup_status == 1)

                                <li class="menu"><a href="{{ route(name: 'customer_signup') }}">{{ $global_page_data->signup_heading }}</a></li>
                                @endif
    ...
    <a href="{{ route('customer_home') }}">
        {{ Auth::guard('customer')->user()->name ?? 'Dashboard' }}
    </a>
</li>
                            @endif
        ...
        <nav class="navbar navbar-expand-md navbar-light">
            ...
            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">        
                    ...
                    @if(isset($global_page_data) && $global_page_data->about_status == 1)
                    <li class="nav-item">
                    ...
                    @if(isset($global_page_data) && ($global_page_data->photo_gallery_status == 1 || $global_page_data->video_gallery_status == 1))
                    <li class="nav-item">
                    ...
                    @if(isset($global_page_data) && $global_page_data->blog_status == 1)
                    <li class="nav-item">
                        <a href="{{ route('blog') }}" class="nav-link">{{ $global_page_data->blog_heading }}</a>
                    </li>
                    @endif

                    @if(isset($global_page_data) && $global_page_data->contact_status == 1)
                    <li class="nav-item">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="useful-links">
                                ...
                                @if(isset($global_page_data) && $global_page_data->photo_gallery_status == 1)
                                <li><a href="{{ route('photo_gallery') }}">{{ $global_page_data->photo_gallery_heading }}</a></li>
                                @endif

                                @if(isset($global_page_data) && $global_page_data->video_gallery_status == 1)
