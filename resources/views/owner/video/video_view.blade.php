...
<a href="{{ route('owner_video_add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('owner_video_edit',$row->id) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('owner_video_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
