...
class OwnerVideoController extends Controller
{
    public function index()
    {
        $videos = Video::get();
        return view('owner.video.video_view', compact('videos'));
    }

    public function add()
    {
        return view('owner.video.video_add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.video.video_edit', compact('video_data'));
    }
